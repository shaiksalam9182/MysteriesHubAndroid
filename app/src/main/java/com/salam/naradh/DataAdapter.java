...
class DataAdapter extends RecyclerView.Adapter<DataAdapter.ItemRowHolder> {
    ...
    public ItemRowHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.custom_post_view,viewGroup,false);
